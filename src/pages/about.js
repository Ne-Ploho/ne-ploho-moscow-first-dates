...
function AboutTemplate(props) {
  ...
  const interviewers = data.allContentfulInterviewer.nodes.filter(
    person => person.node_locale === i18n.locale
  );
        ...
        <AboutContent>
          ...
          <p>
            <Trans id="about.interviewees.stats">
              ...
              первого свидания не было.{'\n'}3 человека не захотели говорить
              из-за эмоций.
            </Trans>
          </p>

          <h3>
            <Trans id="about.interviewers.title">
              Про свидания спрашивали:
            </Trans>
          </h3>
          <p>
